    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-md' : 'bg-transparent'}`}>
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          <Link href="/" className="text-2xl font-bold font-display text-secondary hover:text-secondary transition-colors">
            Royal Mandarin
          </Link>

          {/* Desktop Menu */}
          <div className='space-x-8 hidden md:flex'>
            <Link href="#rooms" className="text-secondary font-semibold hover:text-secondary transition-colors">Rooms</Link>
            <Link href="#dining" className="text-secondary font-semibold hover:text-secondary transition-colors">Dining</Link>
            <Link href="#spa" className="text-secondary font-semibold hover:text-secondary transition-colors">Spa</Link>
            <Link href="#experiences" className="text-secondary font-semibold hover:text-secondary transition-colors">Experiences</Link>
            <Link href="/gallery" className="text-secondary font-semibold hover:text-secondary transition-colors">Gallery</Link>
